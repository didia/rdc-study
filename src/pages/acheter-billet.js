...
import AssistanceBuyTickets from '../components/pages/AssistanceBuyTickets';
...
const Assistance = ({data}) => {
  ...
  return <AssistanceBuyTickets assistancePackages={assistancePackages} services={services} />;
};
...
export const pageQuery = graphql`
  query AssistanceBuyTicketsPageQuery {
