...
import AssistanceConsults from '../components/pages/AssistanceConsults';
...
const Assistance = ({data}) => {
  ...
  return <AssistanceConsults assistancePackages={assistancePackages} services={services} />;
};
...
export const pageQuery = graphql`
  query AssistanceConsultsPageQuery {
