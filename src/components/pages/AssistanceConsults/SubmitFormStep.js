...
// State
import { aboutCandidateState, availableAssistanceTypesState, destinationCountryState, selectedServiceState } from './states';
...
const SubmitFormStep = ({ onNextStep, onRestart, steps }) => {
  ...
  return (
    <StepForm className={styles['submit-step']} title={'Consultation'}>
