      ...
      <section className="mx-8 md:mx-12 mt-10 mb-20 font-['roboto']">
        <div className="text-justify text-xl">
          ...
          <p className="text-base md:text-xl">
            ...
            démarches d’admission et d’obtention des visas moyennant des frais
          ...
          <p className="text-base md:text-xl">
            ...
            dépenser un seul sou pour vos démarches. Toutefois si vous avez
            besoin d‘être accompagné dans vos démarches, RDC Etudes vous offre
            un service d‘accompagnement qui est payant. Pour en savoir plus sur
          ...
          <p className="text-base md:text-xl">
            ...
            fois la demande d’admission obtenue, vous pouvez faire une demande
          ...
          <p className="text-base md:text-xl">
            ...
            correspondent au programme choisi. Par exemple, une personne ayant
            fait la sociologie aura des difficultés de se faire accepter dans la
            faculté
          </p>
          d’informatique.
          <p className="uppercase text-base font-bold py-2 text-start text-red-700">
          ...
          <p className="text-base md:text-xl">
            ...
            année pour le Canada, * Entre 832 et 4200 Euros par année pour la
            Belgique, * Entre 10 000 et 55 000 USD pour les Etats-Unis.
            Existent-ils des bourses pour étudier à l’étranger? Oui, il existe
            des bourses d’études pour étudier à l’étranger. Certaines sont
            complètes c’est à dire couvrent tous vos frais et d’autres sont
            partielles, ne couvrent qu’une partie de vos frais académiques ou
            vous offrent une réduction des frais académiques.\ Toutefois ces
          ...
          <p className="text-base md:text-xl">
            ...
            bourses d’études dont nous sommes au courant sur notre page
          ...
          <p className="text-base md:text-xl">
            ...
            admis par année est très limitée. Toutefois nous vous conseillons de
