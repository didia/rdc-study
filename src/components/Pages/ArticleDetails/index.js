...
const ArticleDetails = ({ article, content, otherArticles }) => {
  ...
  sharedImg =
    article.thumbnail &&
    article.thumbnail.childImageSharp &&
    article.thumbnail.childImageSharp.gatsbyImageData;
  return (
    <Layout pageTitle={article.title}>
      <section>
        ...
        <div className="mx-4 md:mx-28 md:mt-10">
          ...
          <p className="py-2 text-lg text-gray-600 font-['roboto']">
            {article.excerpt}
          </p>
        ...
        <div className="mx-4 md:mx-28">
          <HtmlContent
            content={content}
            htmlclassName="md:text-lg font-['roboto'] mt-10"
          />
        </div>
      </section>
