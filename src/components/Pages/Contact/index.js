        ...
        <div className="grid grid-cols-12 mb-8 mt-4 z-999">
          ...
          <div className="col-span-7 z-10">
            <div className="text-start ml-4">
              <span className={styles.about__title}>Contactez RDC Etudes</span>{" "}
              <p>
                <span
                ...
                >
                  ...
                  d'études. Vous êtes bloqué(e)? Vous ne savez par où commencer
                  ? Nos mentors seront ravis de vous aider a y voir un peu plus
                  clair
                </span>
